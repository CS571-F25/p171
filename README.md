...
## Features
- Home, Events, Dashboard, Contact, and per-event detail pages wired via React Router with a persistent, accessible navigation bar.
...
```bash
npm run build
npm run deploy   # pushes the docs folder via gh-pages
```
